const PickleFilter = require("../../vendor/cucumber-js/lib/pickle_filter").default;
const statuses = require("../../vendor/cucumber-js/lib/status").default;
const {
  SupportCodeLibraryBuilder
} = require("../../vendor/cucumber-js/lib/support_code_library_builder");
...
const { findScenarioByPickle } = require("./astHelpers");
  ...
  for (const { filePath, events, localFilesToRequireFn } of features) {
    ...
    describe(feature.name, () => {
      ...
      picklesToRun.forEach(pickle => {
        ...
        const scenario = findScenarioByPickle(feature, pickle);
